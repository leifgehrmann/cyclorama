...
export function getScenes(highQuality: boolean = false): Record<string, Scene> {
  return {
    ...
    lisbon: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.10-panorama-thumb.jpg',
      infoComponent: Lisbon,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.10-panorama-%d.jpg', 5),
        [3896 * 5],
        [1000],
        0.25,
        0xEED4B1,
    ...
    badajoz: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.5-panorama-thumb.jpg',
      infoComponent: Badajoz,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.5-panorama-%d.jpg', 4),
        [3144 * 4],
        [1000],
        0.45,
        0x000000,
    ...
    vittoria: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.1-panorama-thumb.jpg',
      infoComponent: Vittoria,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.1-panorama-%d.jpg', 3),
        [3698 * 3],
        [1000],
        0.35,
        0xF1D4AC,
    ...
    berlin: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.6-panorama-thumb.jpg',
      infoComponent: Berlin,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.6-panorama-%d.jpg', 3),
        [3670 * 3],
        [1000],
        0.7,
        0xF1D4AC,
    ...
    montmartre: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.13-panorama-thumb.jpg',
      infoComponent: Montmartre,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.13-panorama-%d.jpg', 3),
        [3626 * 3],
        [1000],
        0.4,
        0x1E1F22,
    ...
    elba: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.2-panorama-thumb.jpg',
      infoComponent: Elba,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.2-panorama-%d.jpg', 5),
        [3669 * 5],
        [1000],
        0.3,
        0xF1D4AC,
    ...
    parisStrand: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.4-panorama-thumb.jpg',
      infoComponent: ParisStrand,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.4-panorama-%d.jpg', 4),
        [3713 * 4],
        [1000],
        0.5,
        0xF1D4AC,
    ...
    waterloo: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1886,0111.23.3-panorama-thumb.jpg',
      infoComponent: Waterloo,
      ...buildBarkerGrandCircleParams(
        buildUrls('1886,0111.23.3-panorama-%d.jpg', 4),
        [3768 * 4],
        [1000],
        0.4,
        0xD1B594,
    ...
    algiers: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: 'SLNSW_FL16254393-panorama-thumb.jpg',
      infoComponent: Algiers,
      ...buildBarkerGrandCircleParams(
        buildUrls('SLNSW_FL16254393-panorama-%d.jpg', 4),
        [3831 * 4],
        [1886],
        0.3,
        0xE3DECD,
    ...
    lausanne: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '2010,7081.7379-panorama-thumb.jpg',
      infoComponent: Lausanne,
      ...buildBarkerUpperCircleParams(
        buildUrls('2010,7081.7379-panorama-%d.jpg', 2),
        [3971 * 2],
        [619],
        0.3,
        0xFFFBDA,
    ...
    pandemonium: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: 'SLNSW_FL16254563-panorama-thumb.jpg',
      infoComponent: Pandemonium,
      ...buildBarkerGrandCircleParams(
        buildUrls('SLNSW_FL16254563-panorama-%d.jpg', 4),
        [3566 * 4],
        [1760],
        0.3,
        0xE8E3D0,
    ...
    treport: {
      ...
      selectionScreenGroup: 'barker',
      thumbnail: '/public/1982,U.3982-panorama-thumb.jpg',
      infoComponent: Treport,
      ...buildBarkerGrandCircleParams(
        buildUrls('1982,U.3982-panorama-%d.jpg', 3),
        [3112 * 3],
        [1249],
        0.4,
        0xF3D3AC,
    ...
    hornor: {
      ...
      thumbnail: '/public/1880,1113.1207.1-2-thumb.jpg',
      infoComponent: Hornor,
      ...buildHornorParams(
        buildUrls('1880,1113.1207.1-2-%d.jpg', 7),
        [3999 * 7],
        [2343],
        0.85,
        0xFAEACC,
    ...
    josiahHenshallIllustrative: {
      ...
      selectionScreenGroup: 'hornor',
      thumbnail: '/public/1880,1113.1213-thumb.jpg',
      infoComponent: JosiahHenshallIllustrative,
      ...buildHornorParams(
        buildUrls('1880,1113.1213-%d.jpg', 4),
        [3143 * 4],
        [1109],
        0.8,
        0x2D291E,
    ...
    josiahHenshallDescriptive: {
      ...
      selectionScreenGroup: 'hornor',
      thumbnail: '/public/1880,1113.1214-thumb.jpg',
      infoComponent: JosiahHenshallDescriptive,
      ...buildHornorParams(
        buildUrls('1880,1113.1214-%d.jpg', 4),
        [3197 * 4],
        [1090],
        0.8,
        0xFFFEDF,
    ...
    hornorModern: {
      ...
      selectionScreenGroup: 'hornor',
      thumbnail: '/public/london-thumb.jpg',
