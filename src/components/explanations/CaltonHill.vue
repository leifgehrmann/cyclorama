...
<template>
  ...
  <p>The dimensions of this simulated cyclorama are not the same as the dimensions of the original cyclorama; the original had a much smaller diameter of 25 feet (7 meters).<a href="#citation3"><sup>[3]</sup></a> This simulation uses the same dimensions of the large rotunda at Leicester Square, which has a diameter of 84 feet (25 meters), to demonstrate Robert Barker's desired vision, rather than his initial prototype.</p>
  <hr>
